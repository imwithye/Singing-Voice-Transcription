...
class EffNetb0(nn.Module):
    def __init__(self, pitch_class=12, pitch_octave=4):
        ...
        self.effnet = torch.hub.load(
            "rwightman/gen-efficientnet-pytorch", "efficientnet_b0", pretrained=False
        )
...
if __name__ == "__main__":
    ...
    effnet = EffNetb0().to(DEVICE)
    summary(effnet, input_size=(1, 11, 168))

    # mynet = MyNet().to(DEVICE)
    # summary(mynet, input_size=(1, 11, 168))
